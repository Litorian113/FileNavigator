...
export const SettingsIcon: React.FC<IconProps> = ({ size = 16, className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const BookOpenIcon: React.FC<IconProps> = ({ size = 16, className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 7v14"/>
    <path d="M16 12h2"/>
    <path d="M16 8h2"/>
...
export const FrameIcon: React.FC<IconProps> = ({ size = 16, className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const FlowIcon: React.FC<IconProps> = ({ size = 16, className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ComponentIcon: React.FC<IconProps> = ({ size = 16, className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ArchiveIcon: React.FC<IconProps> = ({ size = 16, className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const LoaderIcon: React.FC<IconProps> = ({ size = 16, className }) => (
  <svg className={`ai-spinner ${className || ''}`} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const getCategoryIcon = (category: string) => {
  switch (category) {
    case 'pages': return FrameIcon;
    case 'flows': return FlowIcon;
    case 'components': return ComponentIcon;
    case 'tests': return ClipboardIcon;
    case 'archive': return ArchiveIcon;
    default: return FrameIcon;
  }
};
